...
const CATEGORIES: { label: string; keywords: string[] }[] = [
  ...
  // NOTE: 'bell pepper' (specific) instead of a bare 'pepper' — a bare 'pepper'
  // here would swallow 'black pepper' (a seasoning) since Produce is checked
  // before Seasonings. Substring match: 'bell pepper' resolves Produce; 'black
  // pepper' has no Produce hit and falls through to Seasonings. (Bare 'red/green
  // pepper' now lands in 'Other' — an accepted trade for correct black pepper.)
  { label: 'Produce', keywords: ['onion', 'garlic', 'tomato', 'carrot', 'broccoli', 'spinach', 'lettuce', 'potato', 'mushroom', 'cucumber', 'celery', 'zucchini', 'cabbage', 'kale', 'corn', 'pea', 'bell pepper', 'apple', 'banana', 'lemon', 'lime', 'orange', 'berry', 'grape', 'mango', 'avocado', 'peach', 'pear', 'herb', 'cilantro', 'parsley', 'scallion', 'ginger'] },
