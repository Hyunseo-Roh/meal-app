...
**Components:** chips (pill; selected = Cool Slate fill) · cards (Greige, 12–16px radius, flat) · primary button (Cool Slate, 52px) · ghost button (1px border) · bottom nav 3 tabs (Home · History · Taste), hidden during onboarding.
