    ...
    >
      ...
      <Tabs.Screen
        ...
        options={{
          ...
          // the tint + filled state like the Ionicons tabs. Rendered at 24 to
          // match the Ionicons tabs' default size.
          tabBarIcon: ({ color, focused }) => (
            <BasketIcon color={color} bg={colors.bg} focused={focused} size={24} />
          ),
        }}
      />
      <Tabs.Screen
